...
{
    /// <inheritdoc />
    public partial class InitialSetupAssignment2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalFlightTime = table.Column<float>(type: "real", nullable: false),
                    Origin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Destination = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EconomyPrice = table.Column<float>(type: "real", nullable: false),
                    BusinessPrice = table.Column<float>(type: "real", nullable: false),
                    MaxPassengersTotal = table.Column<int>(type: "int", nullable: false),
                    PassengersBookedTotal = table.Column<int>(type: "int", nullable: true),
                    MaxPassengersEconomy = table.Column<int>(type: "int", nullable: false),
                    PassengersBookedEconomy = table.Column<int>(type: "int", nullable: true),
                    MaxPassengersBusiness = table.Column<int>(type: "int", nullable: false),
                    PassengersBookedBusiness = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Guest", x => x.GuestUserId);
                });
